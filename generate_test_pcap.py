...
def main():
    ...
    # Loop over original generation pattern 10,000 times to create around 800,000 packets
    for loop_iteration in range(10000):
        # Generate TLS packets
        for dst_ip, sni, dst_port in tls_connections:
            src_port = random.randint(49152, 65535)
            # TCP SYN
    ...
    writer.close()
    print(f"Created test_dpi.pcap with ~800,000 packets!")
